...
('Update brute force file', 'This command updates the file specified with the -f switch with the follwing parameters: a (all): Update using all results; g; Update using only google scraping results; r: Update using only reverse lookup results; z: Update using only zonetransfer results.', 'dnsenum -f subdmains.txt -u a example.com', 14, 'input', '-u', NULL, NULL, 'BRUTE FORCE OPTIONS: UPDATE'),
...
(14, 'Dnsenum', 'Dnsenum', 'information-gathering','The main purpose of Dnsenum is to gather as much information as possible about a domain.', 'https://tools.kali.org/information-gathering/dnsenum', 'https://github.com/fwaeytens/dnsenum', 'Yes', NULL, 'dnsenum', NULL, NULL, 'Vulnerability Analysis', 'Information Gathering', NULL),
